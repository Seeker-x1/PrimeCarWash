...
| 3 | GoogleビジネスプロフィールにサイトURL | **運用（手動）** | ウェブサイト欄に `https://www.出張洗車.jp/` 。公開URLが取れたら `NEXT_PUBLIC_GOOGLE_BUSINESS_PROFILE_URL` を Vercel に入れる（JSON-LD `sameAs`）。 |
| 4 | サイトマップ送信 | **コード + 手動1回** | 本番: `https://www.xn--79q753awyk7z6a.jp/sitemap.xml` （`https://www.出張洗車.jp/sitemap.xml`）。GSC「サイトマップ」にこのフルURLを送信。 |
...
- サイトマップ: `https://www.xn--79q753awyk7z6a.jp/sitemap.xml`
- トップ: `https://www.xn--79q753awyk7z6a.jp/`
- エリア例: `https://www.xn--79q753awyk7z6a.jp/areas/shibuya`

## GBP

1. [ビジネスプロフィール](https://business.google.com) を開く
2. ウェブサイト: `https://www.出張洗車.jp/`
