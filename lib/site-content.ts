...
const commonSizeGroups: SizeGroup[] = [
  ...
  },
  {
    ...
    multiplier: "1.4x",
    cars: [
      "レクサス LS / RX", "レクサス GX / RZ", "アルファード / ヴェルファイア", "LandCruiser 250", "ベンツ Sクラス / GLE", "BMW 7 / X5", "ポルシェ カイエン", "CX-8 / CX-80", "テスラ モデルX"
    ],
  },
  {
    name: "XL",
    multiplier: "1.8x",
    cars: [
      "レクサス LX / LM", "Gクラス", "LandCruiser 300", "センチュリー", "ロールスロイス", "ウルス / ベントレー", "エスカレード", "Defender 130", "マイバッハ", "レンジローバー"
    ],
  },
];
...
export const siteContent: Record<Locale, SiteContent> = {
  ja: {
    ...
    plans: [
      ...
      { name: "継続プラン：月1回", price: "¥6,600", detail: "車外洗浄のみ" },
      { name: "継続プラン：月2回ボディ洗車", price: "¥11,000", detail: "ボディ洗車：月2回", highlight: true },
      { name: "継続プラン：月2回＋内装", price: "¥15,400", detail: "内装＋ボディ洗車＋継続特典付" },
    ],
    ...
    matrixHeaders: {
      ...
      subMonthly1: "継続プラン：月1回（外）",
      subMonthly2Exterior: "継続プラン：月2回（外）",
      subMonthly2Full: "継続プラン：月2回（内＋外）",
    },
